...
@section('content')
    <!-- Page Content Holder -->
        <div id="content">
            ...
            @endif
            <form method="POST" action="{{ route('administra.imatge.pantalla', ['id' => 2]) }}" enctype="multipart/form-data">
                @csrf
            ...
            <div class="row">
                @foreach ($images as $image)
                    <div class="col-md-3 text-center">
                        <img src="{{ asset('img/slides/slide2/' . $image) }}" class="img-thumbnail" style="width: 100%; max-height: 500px;">
                        <form method="POST" action="{{ route('administra.imatge.elimina', ['id' => 2,'filename' => $image]) }}">
                            @csrf
                            @method('DELETE')
